function[emap,bmap,ra,dec,psf_emap,psf_bmap,psf_rlmap,psf,egrid_raw,bgrid_raw,upt,vpt]=make_normalized_pol_map_prefilt(fileroot,data,oversamp,uvthresh);
if (nargin<3)
    oversamp=0;
end
if (nargin<4)
...
[dd,u,v,z,nl,np,ra_cent,dec_cent]=read_split_data([fileroot '_SVEC']);
